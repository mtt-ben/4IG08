...
//     public int particleCount; // Number of particles in this node
...
//     public QuadTree(Vector2 topLeft, Vector2 bottomRight, int capacity)
//     {
...
//         northeast = new QuadTree(new Vector2((topLeft.x + bottomRight.x) / 2, (topLeft.y + bottomRight.y) / 2), bottomRight, capacity);
//         northwest = new QuadTree(topLeft, new Vector2((topLeft.x + bottomRight.x) / 2, (topLeft.y + bottomRight.y) / 2), capacity);
//         southeast = new QuadTree(new Vector2((topLeft.x + bottomRight.x) / 2, topLeft.y), new Vector2(bottomRight.x, (topLeft.y + bottomRight.y) / 2), capacity);
//         southwest = new QuadTree(topLeft, new Vector2((topLeft.x + bottomRight.x) / 2, (topLeft.y + bottomRight.y) / 2), capacity);
//         divided = true;
//     }
